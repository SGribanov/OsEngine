...
| `Jayrock.Json.dll` | `0.9.16530.0` | `project/OsEngine/bin/Debug/Jayrock.Json.dll` | `052EF799BBA47DACD3D7FAAC4F9D629BDD3D50C3FB3BCBF402101A07BEE3976B` | Removed from `OsEngine.csproj`; replaced in code by `Newtonsoft.Json.Linq.JObject`; legacy DLL removed from repo tracking |
| `LiteDB.dll` | `5.0.19.0` | `project/OsEngine/bin/Debug/LiteDB.dll` | `032548393720FC372BD5FD25EE755D6080975E3B27BB94DC9A5BF3DDF2F41C5F` | Migrated: `LiteDB` now comes from `<PackageReference Include="LiteDB" Version="5.0.21" />`; legacy DLL removed from repo tracking |
...
| `RestSharp.dll` | `105.2.3.0` | `project/OsEngine/bin/Debug/RestSharp.dll` | `0A74D75DFBF2193390969008EC0F6ECEB29C8B20363E05192C959B0FAC12F231` | Migrated: `RestSharp` now comes from `<PackageReference Include="RestSharp" Version="106.15.0" />`; legacy DLL removed from repo tracking |
| `TInvestApi.dll` | `1.0.0.0` | `project/OsEngine/bin/Debug/TInvestApi.dll` | `8D85C05E17C2ED7E60E4EFBD5BA33D2ACABB51150D42FBB701E1504356CE1105` | Migrated: now linked via `<ProjectReference Include="..\\..\\related projects\\TInvestApi\\TInvestApi.csproj" />`; legacy DLL removed from repo tracking |
...
2. Keep vendor/custom assemblies (`cgate_net64`, `MtApi5`, `MtClient`, `QuikSharp`, `FinamApi`) as binary or switch to local project references in a separate decision.
