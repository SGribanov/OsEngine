...
| `FinamApi.dll` | `1.0.0.0` | `project/OsEngine/bin/Debug/FinamApi.dll` | `6E303A34921EA0F6C87E4986455CB7D4ED66D66368D7E950C996C917FA3CBE78` | Local project source exists, but binary reference kept for now because `related projects/FinamApi/finam-trade-api/proto/...` is absent in this checkout |
