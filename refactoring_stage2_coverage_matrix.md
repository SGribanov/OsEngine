...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1037` (median): `9231.49 -> 8959.59 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1036 -> #1037`: `2027.88 -> 1676.87 ns/op`, `696.22 -> 696.22 bytes/op`; `load-from-string-malformed #1036 -> #1037`: `2552.43 -> 2169.65 ns/op`, `1184.25 -> 1184.25 bytes/op` | Continue parser-tail hardening on malformed/legacy payloads with focus on allocation drops in malformed KPI while holding current latency gains. |
