...
| Optimizer cache runtime | `Indicators/Aindicator.cs`, `OsOptimizer/OptEntity/IndicatorCache.cs`, `OptimizerMethodCache.cs` | `P2` | High | In Progress | `indicator_cache_hit_path`, `optimizer_method_cache_hit_path` | `indicator #1017 -> #1025`: `4764.65 -> 2193.65 ns/op`, `12952.02 -> 448.02 bytes/op`; `method #1025`: `211.55 ns/op`, `0.01 bytes/op` | Continue P2 on key/hash micro-overheads and cache wiring while preserving deterministic isolation boundaries. |
