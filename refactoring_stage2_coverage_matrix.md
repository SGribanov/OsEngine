...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1054` (median): `9231.49 -> 10751.34 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1042 -> #1054`: `2048.80 -> 2013.45 ns/op`, `32.22 -> 32.01 bytes/op`; `load-from-string-malformed #1042 -> #1054`: `2672.87 -> 2612.58 ns/op`, `466.25 -> 466.14 bytes/op` | Continue parser-tail KPI-gated optimization against `#1042` baseline; keep reliability contracts and consolidate gains with targeted low-risk parser micro-steps. |
