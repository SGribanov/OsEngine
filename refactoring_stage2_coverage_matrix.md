...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1040` (median): `9231.49 -> 9766.92 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1039 -> #1040`: `1721.07 -> 2307.38 ns/op`, `696.22 -> 696.22 bytes/op`; `load-from-string-malformed #1039 -> #1040`: `2515.05 -> 2794.08 ns/op`, `1184.25 -> 1184.25 bytes/op` | Keep parser-tail optimization gate strict: only accept next parser changes with measured latency and/or allocation win on malformed KPI over `#1040` median. |
