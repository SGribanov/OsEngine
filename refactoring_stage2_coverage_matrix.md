...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1042` (median): `9231.49 -> 8206.96 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1040 -> #1042`: `2307.38 -> 2048.80 ns/op`, `696.22 -> 32.22 bytes/op`; `load-from-string-malformed #1040 -> #1042`: `2794.08 -> 2672.87 ns/op`, `1184.25 -> 466.25 bytes/op` | Continue parser-tail hardening with current one-pass span tokenizer baseline; next target is malformed latency below `#1039` while preserving `#1042` allocation gains. |
