...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1053` (median): `9231.49 -> 11857.71 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1042 -> #1053`: `2048.80 -> 2197.15 ns/op`, `32.22 -> 32.01 bytes/op`; `load-from-string-malformed #1042 -> #1053`: `2672.87 -> 2916.33 ns/op`, `466.25 -> 466.14 bytes/op` | Continue parser-tail KPI-gated optimization against `#1042` baseline; keep decimal/date/enum fast-paths and focus next on query-collection allocation reduction consistency. |
