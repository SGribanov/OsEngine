...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1032` (median): `9231.49 -> 8504.17 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1031 -> #1032`: `1605.42 -> 1707.30 ns/op`, `696.22 -> 696.22 bytes/op`; `load-from-string-malformed #1032` (new): `2693.27 ns/op`, `1280.25 bytes/op` | Continue internal non-alloc query/cancel chain and harden parser-tail path further on malformed/legacy payloads while preserving fallback semantics and non-throw contracts. |
