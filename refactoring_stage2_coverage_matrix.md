...
| Optimizer cache runtime | `Indicators/Aindicator.cs`, `OsOptimizer/OptEntity/IndicatorCache.cs`, `OptimizerMethodCache.cs` | `P2` | High | In Progress | `indicator_cache_hit_path` | `#1017 -> #1024` (median): `4764.65 -> 2235.75 ns/op`, `12952.02 -> 448.02 bytes/op` | Continue P2 on key/hash path and method-cache hit-path while preserving deterministic isolation boundaries. |
