...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path` | `query #1017 -> #1031` (median): `9231.49 -> 8331.27 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1031` (new): `1605.42 ns/op`, `696.22 bytes/op` | Continue internal non-alloc query/cancel chain and extend parser KPI with malformed-tail payload variants while preserving fallback semantics. |
