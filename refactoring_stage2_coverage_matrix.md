...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1047` (median): `9231.49 -> 14398.73 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1042 -> #1047`: `2048.80 -> 2240.47 ns/op`, `32.22 -> 32.22 bytes/op`; `load-from-string-malformed #1042 -> #1047`: `2672.87 -> 4341.30 ns/op`, `466.25 -> 466.25 bytes/op` | Continue parser-tail KPI-gated optimization against `#1042` baseline; keep reliability/log wording contracts locked with explicit tests. |
