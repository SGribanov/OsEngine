...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1033` (median): `9231.49 -> 8479.96 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1032 -> #1033`: `1707.30 -> 1599.07 ns/op`, `696.22 -> 696.22 bytes/op`; `load-from-string-malformed #1032 -> #1033`: `2693.27 -> 2286.85 ns/op`, `1280.25 -> 1184.25 bytes/op` | Continue internal non-alloc query/cancel chain and parser-tail hardening on malformed/legacy payloads; next target is lowering malformed-tail allocations/op without behavior drift. |
