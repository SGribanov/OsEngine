...
| Optimizer cache runtime | `Indicators/Aindicator.cs`, `OsOptimizer/OptEntity/IndicatorCache.cs`, `OptimizerMethodCache.cs` | `P2` | High | Planned | `indicator_cache_hit_path` | current median snapshot: `4979.60 ns/op`, `12952.02 bytes/op` (`#1023`, Repeat=5) | Reduce clone/key overhead, keep deterministic isolation guarantees. |
