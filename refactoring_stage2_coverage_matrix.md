...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1041` (median): `9231.49 -> 8880.98 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1040 -> #1041`: `2307.38 -> 3200.85 ns/op`, `696.22 -> 32.22 bytes/op`; `load-from-string-malformed #1040 -> #1041`: `2794.08 -> 3855.02 ns/op`, `1184.25 -> 466.25 bytes/op` | Keep allocation-first parser tuning in P3 and recover RU/malformed latency in follow-up without losing the `#1041` allocation drop. |
