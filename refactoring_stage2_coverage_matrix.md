...
| Optimizer cache runtime | `Indicators/Aindicator.cs`, `OsOptimizer/OptEntity/IndicatorCache.cs`, `OptimizerMethodCache.cs` | `P2` | High | In Progress | `indicator_cache_hit_path`, `optimizer_method_cache_hit_path` | `indicator #1017 -> #1026`: `4764.65 -> 1963.45 ns/op`, `12952.02 -> 448.02 bytes/op`; `method #1025 -> #1026`: `211.55 -> 137.03 ns/op`, `0.01 -> 0.01 bytes/op` | Continue P2 on cache-key/source-id representation and method-cache key-build overhead while preserving deterministic isolation boundaries. |
