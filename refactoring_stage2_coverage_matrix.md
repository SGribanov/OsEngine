...
|---|---|---|---|---|---|---|---|
| TradeGrid runtime | `OsTrader/Grids/TradeGrid.cs` hot query/cancel/parser paths | `P1/P3` | High | In Progress | `tradegrid_query_collections_hotpath`, `tradegrid_load_from_string_ru_payload_path`, `tradegrid_load_from_string_malformed_tail_path` | `query #1017 -> #1052` (median): `9231.49 -> 8497.46 ns/op`, `1856.01 -> 992.01 bytes/op`; `load-from-string-ru #1042 -> #1052`: `2048.80 -> 2444.10 ns/op`, `32.22 -> 32.22 bytes/op`; `load-from-string-malformed #1042 -> #1052`: `2672.87 -> 3219.05 ns/op`, `466.25 -> 466.25 bytes/op` | Continue parser-tail KPI-gated optimization against `#1042` baseline; preserve compatibility fallbacks while iterating on low-overhead parse fast-paths. |
