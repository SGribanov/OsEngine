...
| Optimizer cache runtime | `Indicators/Aindicator.cs`, `OsOptimizer/OptEntity/IndicatorCache.cs`, `OptimizerMethodCache.cs`, `OsTrader/Panels/BotPanel.cs` | `P2` | High | In Progress | `indicator_cache_hit_path`, `optimizer_method_cache_hit_path`, `optimizer_cache_key_build_path`, `optimizer_method_parameter_hash_path` | `indicator #1017 -> #1029`: `4764.65 -> 1966.80 ns/op`, `12952.02 -> 448.02 bytes/op`; `method #1025 -> #1029`: `211.55 -> 150.22 ns/op`, `0.01 -> 0.01 bytes/op`; `key-build #1029`: `320.15 ns/op`, `0.01 bytes/op`; `parameter-hash #1029 (new)`: `184.79 ns/op`, `40.04 bytes/op` | Continue P2 on method-cache path by reducing residual string allocation pressure in parameter-hash flow while preserving deterministic key compatibility and isolation boundaries. |
