...
public class OrderPersistenceTests
{
    ...
    [Fact]
    public void SetOrderFromString_ShouldParseNumericStateValue()
    {
        Order source = new Order
        {
            NumberUser = 15,
            ServerType = ServerType.None,
            NumberMarket = "ord-legacy-numeric-state",
            Side = Side.Buy,
            Price = 72m,
            Volume = 2m,
            VolumeExecute = 1m,
            State = OrderStateType.None,
            TypeOrder = OrderPriceType.Limit,
            SecurityNameCode = "SEC8",
            PortfolioNumber = "PF8",
            TimeCallBack = new DateTime(2026, 2, 27, 18, 10, 10),
            TimeCreate = new DateTime(2026, 2, 27, 18, 10, 0),
            LifeTime = TimeSpan.FromMinutes(1),
            Comment = "legacy-numeric-state",
            OrderTypeTime = OrderTypeTime.Day
        };
    ...
    [Fact]
    public void SetOrderFromString_ShouldParseNumericActiveStateValue()
    {
        Order source = new Order
        {
            NumberUser = 16,
            ServerType = ServerType.None,
            NumberMarket = "ord-legacy-numeric-active",
            Side = Side.Sell,
            Price = 73m,
            Volume = 1m,
            VolumeExecute = 0m,
            State = OrderStateType.None,
            TypeOrder = OrderPriceType.Limit,
            SecurityNameCode = "SEC9",
            PortfolioNumber = "PF9",
            TimeCallBack = new DateTime(2026, 2, 27, 19, 10, 10),
            TimeCreate = new DateTime(2026, 2, 27, 19, 10, 0),
            LifeTime = TimeSpan.FromMinutes(1),
            Comment = "legacy-numeric-active",
            OrderTypeTime = OrderTypeTime.Day
        };
    ...
    [Fact]
    public void SetOrderFromString_ShouldParseNumericCancelStateValue()
    {
        Order source = new Order
        {
            NumberUser = 17,
            ServerType = ServerType.None,
            NumberMarket = "ord-legacy-numeric-cancel",
            Side = Side.Buy,
            Price = 74m,
            Volume = 1m,
            VolumeExecute = 0m,
            State = OrderStateType.None,
            TypeOrder = OrderPriceType.Limit,
            SecurityNameCode = "SEC10",
            PortfolioNumber = "PF10",
            TimeCallBack = new DateTime(2026, 2, 27, 20, 10, 10),
            TimeCreate = new DateTime(2026, 2, 27, 20, 10, 0),
            LifeTime = TimeSpan.FromMinutes(1),
            Comment = "legacy-numeric-cancel",
            OrderTypeTime = OrderTypeTime.Day
        };
    ...
    [Fact]
    public void SetOrderFromString_ShouldParseNumericNoneStateValue()
    {
        Order source = new Order
        {
            NumberUser = 22,
            ServerType = ServerType.None,
            NumberMarket = "ord-legacy-numeric-none",
            Side = Side.Sell,
            Price = 79m,
            Volume = 1m,
            VolumeExecute = 0m,
            State = OrderStateType.Active,
            TypeOrder = OrderPriceType.Limit,
            SecurityNameCode = "SEC15",
            PortfolioNumber = "PF15",
            TimeCallBack = new DateTime(2026, 2, 28, 1, 10, 10),
            TimeCreate = new DateTime(2026, 2, 28, 1, 10, 0),
            LifeTime = TimeSpan.FromMinutes(1),
            Comment = "legacy-numeric-none",
            OrderTypeTime = OrderTypeTime.Day
        };
