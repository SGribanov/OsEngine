...
public sealed class BybitDataArchiveTempWriteTests : IDisposable
{
    private readonly string _tempDirectory;

    public BybitDataArchiveTempWriteTests()
    {
        _tempDirectory = Path.Combine(Path.GetTempPath(), "osengine-bybit-archive-" + Guid.NewGuid().ToString("N"));
    ...
    {
        string archivePath = Path.Combine(_tempDirectory, "archive.gz");
    ...
    {
        string archivePath = Path.Combine(_tempDirectory, "broken.gz");
