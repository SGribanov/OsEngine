...
public class PivotPersistenceTests
{
    [Fact]
    public void Save_ShouldPersistJson_AndLoadRoundTrip()
    {
        const string name = "CodexPivotJson";
        using PivotFileScope scope = new PivotFileScope(name);

        Pivot source = new Pivot(name, canDelete: true)
        {
            ColorP = Color.Gold,
        ...
        Pivot loaded = new Pivot(name, canDelete: true);
        ...
        Assert.Equal(Color.Brown.ToArgb(), loaded.ColorS4.ToArgb());
        ...
        Assert.Equal(Color.RoyalBlue.ToArgb(), loaded.ColorR4.ToArgb());
    ...
    {
        const string name = "CodexPivotLegacy";
        using PivotFileScope scope = new PivotFileScope(name);
    ...
    private sealed class PivotFileScope : IDisposable
    {
        ...
        public PivotFileScope(string name)
        {
