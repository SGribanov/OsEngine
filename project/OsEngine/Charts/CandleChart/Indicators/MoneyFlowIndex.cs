...
namespace OsEngine.Charts.CandleChart.Indicators
{
    public class MoneyFlowIndex : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                MoneyFlowIndexSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static MoneyFlowIndexSettingsDto ParseLegacySettings(string content)
        {
        ...
        private sealed class MoneyFlowIndexSettingsDto
        {
