...
namespace OsEngine.Charts.CandleChart.Indicators
{
    public class PivotPoints: IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                PivotPointsSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static PivotPointsSettingsDto ParseLegacySettings(string content)
        {
            ...
            return new PivotPointsSettingsDto
            {
                ...
                ColorR1Argb = ParseColorLegacy(lines[4]).ToArgb(),
                ColorR2Argb = ParseColorLegacy(lines[5]).ToArgb(),
                ColorR3Argb = ParseColorLegacy(lines[6]).ToArgb(),
                PaintOn = Convert.ToBoolean(lines[7])
            };
        }
        ...
        private sealed class PivotPointsSettingsDto
        {
