...
namespace OsEngine.Charts.CandleChart.Indicators
{
    ...
    public class Momentum : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                MomentumSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static MomentumSettingsDto ParseLegacySettings(string content)
        {
        ...
        private sealed class MomentumSettingsDto
        {
