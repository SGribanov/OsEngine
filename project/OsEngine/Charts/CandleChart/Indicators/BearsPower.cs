...
namespace OsEngine.Charts.CandleChart.Indicators
{
    ...
    public class BearsPower : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                BearsPowerSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static BearsPowerSettingsDto ParseLegacySettings(string content)
        {
            ...
            return new BearsPowerSettingsDto
            {
        ...
        private sealed class BearsPowerSettingsDto
        {
