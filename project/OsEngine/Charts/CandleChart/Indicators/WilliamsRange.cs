...
namespace OsEngine.Charts.CandleChart.Indicators
{
    ...
    public class WilliamsRange : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                WilliamsRangeSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static WilliamsRangeSettingsDto ParseLegacySettings(string content)
        {
            ...
            return new WilliamsRangeSettingsDto
            {
        ...
        private sealed class WilliamsRangeSettingsDto
        {
