...
namespace OsEngine.Charts.CandleChart.Indicators
{
    public class OnBalanceVolume : IIndicator
    {
        ...
        public void Save()
        {
            try
            {
                ...
                SettingsManager.Save(
                    GetSettingsPath(),
                    new OnBalanceVolumeSettingsDto
                    {
        ...
        public void Load()
        {
            ...
            try
            {
                OnBalanceVolumeSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static OnBalanceVolumeSettingsDto ParseLegacySettings(string content)
        {
        ...
        private sealed class OnBalanceVolumeSettingsDto
        {
