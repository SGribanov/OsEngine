...
namespace OsEngine.Charts.CandleChart.Indicators
{
    ...
    public class ForceIndex : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                ForceIndexSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static ForceIndexSettingsDto ParseLegacySettings(string content)
        {
            ...
            return new ForceIndexSettingsDto
            {
        ...
        private sealed class ForceIndexSettingsDto
        {
