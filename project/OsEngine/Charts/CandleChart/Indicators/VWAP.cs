    ...
    public class Vwap : IIndicator
    {
        ...
        private static VwapSettingsDto ParseLegacySettings(string content)
        {
            ...
            return new VwapSettingsDto
            {
                ...
                ColorDateArgb = Convert.ToInt32(lines[9], CultureInfo.InvariantCulture),
                ColorDateDevArgb = Convert.ToInt32(lines[10], CultureInfo.InvariantCulture),
                ...
                ColorDayArgb = Convert.ToInt32(lines[15], CultureInfo.InvariantCulture),
                ColorDayDevArgb = Convert.ToInt32(lines[16], CultureInfo.InvariantCulture),
                ...
                ColorWeekArgb = Convert.ToInt32(lines[21], CultureInfo.InvariantCulture),
                ColorWeekDevArgb = Convert.ToInt32(lines[22], CultureInfo.InvariantCulture),
