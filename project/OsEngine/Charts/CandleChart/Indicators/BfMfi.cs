...
namespace OsEngine.Charts.CandleChart.Indicators
{
    public class BfMfi : IIndicator
    {
        ...
        public void Load()
        {
            ...
            try
            {
                BfMfiSettingsDto settings = SettingsManager.Load(
                    GetSettingsPath(),
                    defaultValue: null,
        ...
        private static BfMfiSettingsDto ParseLegacySettings(string content)
        {
        ...
        private sealed class BfMfiSettingsDto
        {
