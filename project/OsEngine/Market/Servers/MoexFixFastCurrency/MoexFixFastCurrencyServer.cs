...
namespace OsEngine.Market.Servers.MoexFixFastCurrency
{
    ...
    public class MoexFixFastCurrencyServerRealization : IServerRealization
    {
        ...
        public void Dispose()
        {
            ...
            lock (_logLockMFIX)
            {
                DisposePersistentLogWriter(ref _logFXMFIXMsg);
            }
...
#pragma warning restore CS0169
        ...
        private StreamWriter _logFXMFIXMsg;
        ...
        private void WriteLogFXMFIXTrade(string fixMessage)
        {
            lock (_logLockMFIX)
            {
                WritePersistentLogLine(ref _logFXMFIXMsg, GetIncomingMfixLogPath(), true, fixMessage, DateTime.Now);
            }
        }
